...
Upper Bound?
->Upper Bound is the smallest index where arr[i]>x
...
->Then if arr[mid]>x,it is a possible upper bound but you need to find smallest
...
int main()
{
    ...
    int x;
    cout<<"Enter the element you want upperBound for:"<<endl;
    cin>>x;
